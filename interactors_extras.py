...
class subfilter(object):
    ...
    def __init__(self, rxstr, attribute):
        ...
        if ( attribute not in I.VALID_FIELDS_INTERACTIONS ) and (attribute not in I.VALID_FIELDS_NODES ):
...
def bg_regex_assembler(iorg="") :
    ...
    from lib.rbase import exores,endores,cytores,highly_variable,pseudogenes
